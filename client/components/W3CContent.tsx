    ...
    <div className="w-full bg-white border border-tr-gray-200 rounded-lg overflow-hidden">
      ...
      <div className="bg-tr-gray-50 px-4 py-3 border-b border-tr-gray-200">
        <div className="flex items-center gap-3">
          ...
          />
          <div>
            <h3 className="font-semibold text-tr-gray-900 text-sm">W3C Web Accessibility Initiative</h3>
            <p className="text-xs text-tr-gray-400">Dialog (Modal) Pattern | APG | WAI | W3C</p>
          </div>
        </div>
      </div>
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="space-y-3">
          <h4 className="font-bold text-tr-gray-900 text-xl">Dialog (Modal) Pattern</h4>
          <p className="text-sm text-tr-gray-400 leading-relaxed">
            A dialog is a window overlaid on either the primary window or another dialog window. 
            Windows under a modal dialog are inert. That is, users cannot interact with content 
            outside an active dialog window.
          </p>
        </div>

        {/* Key Characteristics */}
        <div className="space-y-3">
          <h5 className="font-semibold text-tr-gray-900">Key Characteristics</h5>
          <ul className="text-sm text-tr-gray-400 space-y-2 list-disc list-inside ml-4">
            <li>Inert content: Users cannot interact with content outside the active dialog</li>
            <li>Focus management: Focus moves to an element inside the dialog</li>
            <li>Escape hatch: Users can close the dialog by pressing Escape</li>
            <li>Modal overlay: Background content is typically dimmed or blurred</li>
          </ul>
        </div>

        {/* Accessibility Features */}
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
          <h5 className="font-semibold text-blue-900 mb-3">Accessibility Features</h5>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
            <div>
              <h6 className="font-medium text-blue-800 mb-2">Keyboard Support</h6>
              <ul className="text-blue-700 space-y-1 list-disc list-inside ml-2">
                <li><kbd className="bg-blue-100 px-1 rounded">Tab</kbd> - Moves focus to next focusable element</li>
                <li><kbd className="bg-blue-100 px-1 rounded">Shift + Tab</kbd> - Moves focus to previous element</li>
                <li><kbd className="bg-blue-100 px-1 rounded">Escape</kbd> - Closes the dialog</li>
              </ul>
            </div>
            <div>
              <h6 className="font-medium text-blue-800 mb-2">ARIA Attributes</h6>
              <ul className="text-blue-700 space-y-1 list-disc list-inside ml-2">
                <li><code className="bg-blue-100 px-1 rounded text-xs">role="dialog"</code></li>
                <li><code className="bg-blue-100 px-1 rounded text-xs">aria-labelledby</code></li>
                <li><code className="bg-blue-100 px-1 rounded text-xs">aria-describedby</code></li>
                <li><code className="bg-blue-100 px-1 rounded text-xs">aria-modal="true"</code></li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-3">
          <h5 className="font-semibold text-tr-gray-900">HTML Structure Example</h5>
  ...
  <div>
    ...
    <button type="button">Delete</button>
          ...
          <div className="space-y-3">
            <div className="border-l-4 border-green-400 bg-green-50 p-3">
              ...
              <ul className="text-sm text-green-700 space-y-1 mt-1 list-disc list-inside ml-2">
                <li>Move focus to an appropriate element within the dialog when it opens</li>
                <li>Trap focus within the dialog while it's open</li>
                <li>Return focus to the element that triggered the dialog when it closes</li>
        ...
        <div className="border-t border-tr-gray-200 pt-4">
          <h5 className="font-medium text-tr-gray-900 text-sm mb-3">Related W3C Resources</h5>
