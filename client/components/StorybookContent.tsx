    ...
    <div className="w-full bg-white border border-tr-gray-200 rounded-lg overflow-hidden">
      ...
      <div className="bg-tr-gray-50 px-4 py-3 border-b border-tr-gray-200">
        <div className="flex items-center gap-3">
          ...
          />
          <div>
            <h3 className="font-semibold text-tr-gray-900 text-sm">Storybook</h3>
      ...
      <div className="p-6 space-y-4">
        <div className="space-y-2">
          ...
          <p className="text-sm text-tr-gray-400 leading-relaxed">
            The Saffron dialog component is a reusable modal dialog implementation that follows Thomson Reuters design system guidelines. It provides accessible, keyboard-navigable modal dialogs with customizable content and actions.
          </p>
        </div>
        ...
        <div className="space-y-3">
          ...
          <div className="bg-tr-gray-50 rounded p-3 text-xs font-mono">
            <div className="space-y-1">
              <div><span className="text-blue-600">isOpen</span>: <span className="text-green-600">boolean</span> - Controls dialog visibility</div>
              <div><span className="text-blue-600">onClose</span>: <span className="text-green-600">function</span> - Callback when dialog closes</div>
              <div><span className="text-blue-600">title</span>: <span className="text-green-600">string</span> - Dialog header title</div>
              <div><span className="text-blue-600">size</span>: <span className="text-green-600">'sm' | 'md' | 'lg'</span> - Dialog size variant</div>
              <div><span className="text-blue-600">variant</span>: <span className="text-green-600">'modal' | 'alert'</span> - Dialog type</div>
            </div>
          </div>
        </div>
        ...
        {/* Usage Example */}
        <div className="space-y-3">
          <h5 className="font-medium text-tr-gray-900 text-sm">Usage Example</h5>
  ...
  <DialogActions>
    ...
    <Button variant="primary" onClick={handleConfirm}>
      Confirm
        ...
        {/* Interactive Preview */}
        <div className="space-y-3">
          <h5 className="font-medium text-tr-gray-900 text-sm">Interactive Preview</h5>
        ...
        {/* Accessibility Notes */}
        <div className="space-y-3">
          <h5 className="font-medium text-tr-gray-900 text-sm">Accessibility</h5>
          <ul className="text-sm text-tr-gray-400 space-y-1 list-disc list-inside">
            ...
            <li>Screen reader compatible with aria-labelledby and aria-describedby</li>
          </ul>
        </div>
      </div>
    </div>
